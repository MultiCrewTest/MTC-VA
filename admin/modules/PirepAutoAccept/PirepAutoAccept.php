 ...
 */
    ...
    class PirepAutoAccept extends CodonModule {
        ...
        protected function edit_settings_post()
        {
            ...
            PirepAcData::editSettings($this->post->setting_id, $this->post->moduleenabled,$this->post->landing_rate, $this->post->send_mail_to_admin, $this->post->send_mail_to_pilot,$this->post->admin_code);
