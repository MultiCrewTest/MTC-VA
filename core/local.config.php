...
define('DBASE_PASS', 'd5r9n5zamxadpte7');
...
define('SITE_URL', 'http://fly.multicrew.co.uk');
...
Config::Set('EMAIL_SMTP_USER', 'noreply@multicrew.co.uk');
Config::Set('EMAIL_SMTP_PASS', 'wercitlum');
