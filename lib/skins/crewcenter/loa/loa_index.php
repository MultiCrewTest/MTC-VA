...
<p>
LoA Information: <br/>
The LoA starts on the date the form is submitted and ends on the user selected date provided that the date the leave of absence is not longer than 60 days. After that time you will agian be subjected to the inactivity policy. <br>
<hr />
