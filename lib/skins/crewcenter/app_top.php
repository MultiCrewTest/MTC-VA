        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu">
					...
					<li>
						<a href="http://multicrew.co.uk" target="_blank">
							<i class="fa fa-plane"></i><span>MultiCrew Home Page</span>
						</a>
					</li>
					<li>
						<a href="http://forums.multicrew.co.uk" target="_blank">
							<i class="fa fa-users"></i><span> MultiCrew Forums</span>
						</a>
					</li>
                    <li>
					...
					<li>
                        <a href="<?php echo url('/pilots'); ?>">
                            <i class="fa fa-list"></i> <span>Pilots List</span>
                        </a>
                    </li>
					<li>
						<a href="<?php echo url('/wthr'); ?>">
							<i class="fa fa-cloud"></i> <span>Weather</span>
						</a>
					</li>
                    <li>
					...
					<!--<li>
						<a href="<?php echo url('/Exams'); ?>">
							<i class="fa fa-question-circle"></i> <span>Exam Center</span>
						</a>
					</li>-->
					
					<!--<li>
						<a href="<?php echo url('/Mail'); ?>">
							<i class="fa fa-envelope"> </i> <span>AIRMail</span>
						</a>
					</li>-->
					...
					$admin = ExamsData::check_admin(Auth::$userinfo->pilotid);
									...
									{echo '<!--<li><a href="'.url('/Exams_admin').'"><i class="fa fa-check"></i><span>Exam Center Admin</span></a>';}
					?>-->
